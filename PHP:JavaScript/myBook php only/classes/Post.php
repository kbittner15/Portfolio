...
class post{
    ...
    public static function createPost($postbody, $loggedInUserId, $profileUserId){
        ...
        DB::query('INSERT INTO posts VALUES (null, :postbody, NOW(), :userid, 0, null, :topics, :public)', array(':postbody'=>$postbody, ':userid'=>$profileUserId, ':topics'=>$topics, ':public'=>$public));
    ...
    public static function createImgPost($postbody, $loggedInUserId, $profileUserId){
        ...
        if ($loggedInUserId == $profileUserId) {
                ...
                DB::query('INSERT INTO posts VALUES (null, :postbody, NOW(), :userid, 0, null, :topics, :public)', array(':postbody'=>$postbody, ':userid'=>$profileUserId, ':public'=>$public));
