...
<a class="active" href="localhost:8888/index.php">Home</a>
 <a href="localhost:8888/index.php">Now</a>
  <a href="localhost:8888/index.php">Popular</a>
...
<?php
$followingposts = DB::query('SELECT posts.id, posts.body, posts.upvotes, users.`username` FROM users, posts, followers
